...
Warframe está disponível na interface com um roster verificável de Excalibur, Mag, Volt, Rhino, Frost e Ember e uma build F2P inicial para cada um, versionada no snapshot do Update 43.5 com fontes externas registradas. A apresentação usa vocabulário específico de Warframe, incluindo Warframes, Mods e Esquadrão.
...
- **Warframe** — disponível com seis Warframes acompanhados e uma build F2P inicial para Excalibur, Mag, Volt, Rhino, Frost e Ember.
